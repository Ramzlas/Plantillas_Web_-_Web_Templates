...
#### EN: 
This repository contains the modules whose interactive and visual samples can be found on my **[CodePen Profile](https://codepen.io/Ramzlas)**. It was created to document and centralize my web development models.
